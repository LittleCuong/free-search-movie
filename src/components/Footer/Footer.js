        ...
        <div className={cx('wrapper', 'grid')}>
            <div className={cx('information')}>
                <div className={cx('information-col')}>
                    <span className={cx('information-item-title')}>The Basics</span>                  
                ...
                <div className={cx('information-col')}>
                    <span className={cx('information-item-title')}>Legal</span>                  
                ...
                <div className={cx('information-col')}>
                    <span className={cx('information-item-title')}>Features</span>                  
            ...
            <div className={cx('information-social')}>
